...
Horizon Tracker is a full-stack, Kanban-style task management POC built with a **Node.js/Express + Sequelize (MySQL)** backend and a **React + Zustand** frontend. It features a responsive, glassmorphic dark-mode interface designed for tracking tasks, assigning roles, and visualizing team workloads through database-level aggregates.
